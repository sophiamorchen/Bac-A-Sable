...
const myObj: { [key: symbol]: string } = {};  // Déclare un objet avec des clés de type "symbol" et des valeurs de type "string".
...
type MyType = {  // Déclare un type "MyType" avec une propriété dont la clé est "mySymbol4" et la valeur est un "boolean".
    [mySymbol4]: boolean;  // La clé est un symbole, la valeur doit être de type "boolean".
};
